...
function DashboardPage() {
    ...
    const fetchDashboard = async () => {
      try {
        ...
        try {
          ...
          // If mock data fails, show minimal data
          setData({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Data Summary Cards (simple bar displays - no recharts for reliability) */}
        ...
        <Card className="bg-white border-[#e5e7eb] rounded-xl lg:col-span-3">
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                {(data.recentTrades?.length ? data.recentTrades : []).map((t, i) => (
                  <TableRow key={t.id || i} className="border-[#f0f2f5] hover:bg-[#f7f8fc] cursor-pointer">
